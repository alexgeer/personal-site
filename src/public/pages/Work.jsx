...
let Stack = () => {
  ...
  return(
    <StackContainer>
      ...
      <div><img src="images/express.png" alt=""/></div>
    </StackContainer>
  )
}
function Work() {
    ...
    <PageWrapper>
      ...
      <div>
        ...
        <p>
          ...
          the company. This where I cut my teeth on the meat and potatoes of web development: routing, HTTP, APIs, RESTful interfaces,
          data modeling, and so on. This also where I began learning about and using some of popular JS frameworks: React, styled-components, Express
          , Knex.
        </p>
          <p>
        ...
        <h5>A payment and registration React/Node app with an admin 
          ...
          <p>There was an existing app, but I was tasked with refactoring it into ES6 and ended up rewriting
            80-90% of the original code, including a new DB schema.
          </p>
          <p>The front end was made with React. 
            I wrote all the reusable form input components, using Bootstrap for basic styling. The main learning
          ...
          <p>
            ...
            The data environment was fairly extensive, so I got to work alot with parsing, stringifying,
